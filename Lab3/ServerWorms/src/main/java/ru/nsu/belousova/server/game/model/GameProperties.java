...
public class GameProperties {
    ...
    public static final int SCORE_FOR_KILL;
    public static final int GAME_SPEED;
    public static final int COUNT_FOODS;
    ...
    static {
        ...
        try {
            ...
            MIN_HEIGHT = Integer.parseInt(properties.getProperty("MIN_HEIGHT"));
            ...
            SCORE_FOR_KILL = Integer.parseInt(properties.getProperty("SCORE_FOR_KILL"));
            GAME_SPEED = Integer.parseInt(properties.getProperty("GAME_SPEED"));
            COUNT_FOODS = Integer.parseInt(properties.getProperty("COUNT_FOODS"));
        } catch (IOException e) {
